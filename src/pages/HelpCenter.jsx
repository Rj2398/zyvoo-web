  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="help-center-wrap"
          style={{
            margin: isMobileWidth ? "0" : "auto",
            padding: isMobileWidth ? "0" : "auto",
          }}
        >
          <Container
            fluid
          ...
          >
            <Row
              style={{
                padding: isMobileWidth ? "0" : "0 26px",
                margin: isMobileWidth ? "0" : "0 -15px",
              }}
            >
              <Col lg={12}>
                <div
                  ...
                  style={{
                    textAlign: "center",
                    padding: isMobileWidth ? "10px 0" : "30px 0",
                  }}
                >
                  <h1>
                    {" "}
                ...
                >
                  ...
                  <h2 style={{ marginTop: "20px" }}>
                    ...
                    <Link
                      ...
                      state={{
                        type: type,
                        user_fname: helpCenterData?.user_fname,
              ...
              {filteredGuides.map((guide, index) => (
                <Col
                  ...
                  xs={6}
                  key={guide?.id}
                  className={isMobileWidth ? "mb-0" : "mb-4"}
                >
                  <Card
                    className="help-center-guides"
                    style={{
                      textAlign: "center",
                      borderRadius: "22px",
                      padding: "0px",
              ...
              >
                <Col lg={12} className="mb-3">
                  ...
                  >
                    <h2
                      style={{
                        marginBottom: isMobileWidth ? "1px" : "20px",
                        padding: "0",
                      }}
                    >
                      Top Articles{" "}
                ...
                {filteredArticles.map((article, index) => (
                  <Col lg={4} md={6} key={index} className="mb-4">
                    <Card
                      className="help-center-articles"
