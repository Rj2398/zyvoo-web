...
const ExploreArticles = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className="explore-guides-articles-wrap mob-explore-article"
            ...
            <Row className="mt-4 mb-4">
              <Col xs={12} md={6} lg={4} className="d-flex">
                <h3
                  ...
                  style={{
                    color: "black",
                    marginTop: isMobileWidth ? "-32px" : "50px",
                    fontWeight: "400",
                  }}
                >
                  Our new articles
                ...
                filteredArticles1.map((article, index) => (
                  ...
                  >
                    <div className="explore-guides-articles-in text-center">
                      ...
                      >
                        <div
                          className="explore-guides-articles-image"
                          style={{ height: isMobileWidth && "260px " }}
                        >
                          <Image
                            src={`${imageBase}${article.cover_image}`}
                        ...
                        <div
                          className="article-description text-start"
